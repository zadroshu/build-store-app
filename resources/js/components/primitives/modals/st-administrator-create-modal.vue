      ...
      <div class="st-order-modal__wrapper">
        <div class="st-order-modal__container">
            ...
            <div class="st-order-modal__body">
                ...
                <st-input v-model="props.item.password" placeholder="Пароль" type="password" />
                <st-input v-model="props.item.passwordConfirmation" placeholder="Подтверждение пароля" type="password" />
            </div>

            <div class="st-order-modal__footer">
            <slot name="st-order-modal__footer">
                <st-button class="st-order-modal__footer-btn" value="Нет" @click="$emit('closeCreateAdmin')" />
                <st-button class="st-order-modal__footer-btn" value="Да" :disabled="!props.item.password || (props.item.password !== props.item.passwordConfirmation)" @click="$emit('createAdmin', item)" />
            </slot>
          </div>
        </div>
      </div>
...
const emit = defineEmits(['close', 'createAdmin', 'closeCreateAdmin']); 
