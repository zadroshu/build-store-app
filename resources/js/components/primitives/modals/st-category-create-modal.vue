      ...
      <div class="st-category-modal__wrapper">
        <div class="st-category-modal__container">
            ...
            <slot name="st-category-modal__footer">
                <st-button class="st-category-modal__footer-btn" value="Нет" @click="$emit('closeCreateCategory')" />
                <st-button class="st-category-modal__footer-btn" value="Да" @click="$emit('CreateCategory', item)" />
            </slot>
          </div>
        </div>
      </div>
...
const emit = defineEmits(['CreateCategory', 'closeCreateCategory']); 
